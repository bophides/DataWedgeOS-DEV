...
class MainActivity : AppCompatActivity(), Observer, View.OnTouchListener, View.OnClickListener {
    ...
    private val PICKFILE_RESULT_CODE = 0x9001;

    companion object {
        const val PROFILE_NAME = "OptoSigma USA"
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            R.id.action_settings -> {
                val bundle = Bundle();
                bundle.putSerializable("allScans", this.scans);
                ...
                settingsIntent.putExtra("scanBundle", bundle);
    ...
    private fun processCSVImport(uri:Uri) {
        ...
        val s = String(byteArray, StandardCharsets.UTF_8)

        // TODO: Parse CSV and Barcode here
        Toast.makeText(this, s, 2000).show();
    }
